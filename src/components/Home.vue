<template>
    <div class="content">
      <div>
        ...
        <img src="/public/images/chris-000.jpg" v-on:mouseover="hideNav = false" v-on:mouseleave="hideNav = true" />
  ...
  export default {
    data() {
      return {
        hideNav: true,
        imageSource: '/public/images/chris-000.jpg',
      }
    },
    created() {
      ...
      setInterval(() => {
        ...
        this.imageSource = imageDir + images[index];
